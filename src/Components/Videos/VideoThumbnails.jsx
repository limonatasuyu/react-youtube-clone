...
import {shortenNumber, getTimeChange, getDurationObj} from '../../Helpers/HelperFunctions'
		...
		<Link to={data ? `/watch?q=${data.id}` : "/"} className="video-thumbnail" style={{textDecoration: "none", color: "Black"}}>
				...
				<div className="video-details flex">
					<div className="channel-img--thumbnail">
						<img src={props.channelData.snippet.thumbnails.high.url} onError={(e) => {console.log(e)}} alt="channel-pp"/>
					</div>
